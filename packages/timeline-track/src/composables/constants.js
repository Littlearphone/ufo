...
export const TAB_NAMES = ['基础操作', '密集数据', 'API 调用', '布局 / 共用轴', '模式示例', 'Vue 3 集成']
export const TAB_DESCS = [
  ...
  '展示 <code>type</code> / <code>unit</code> 多模式：<strong>自然时间</strong> · <strong>秒级</strong> · <strong>百分比</strong> · <strong>像素</strong>',
